...
<div id="wrap">
  ...
  <div id="homepage-slider-wrap" class="clr flexslider-container">   
		<div id="homepage-slider1" class="flexslider1">
		  <?php if ($page['slider_blog']): ?>
				   <?php print render ($page['slider_blog']); ?>
			<?php endif; ?>
		</div>     
 ...
 <div id="first-container">
  <?php if ($is_front): ?>
		  <?php if($page['slogan_area']): ?>
		   <div id="slogan-wrap" class="site-preface clr">
				 <div id="slogan" class="clr container">
				  <?php print render ($page['slogan_area']); ?>
				  </div>
		   </div>
		  <?php endif; ?>
<?php endif; ?>
    ...
    <div id="preface" class="clr container">
      <?php if ($page['preface_first'] || $page['preface_middle'] || $page['preface_last']): ?>
        <div id="preface-block-wrap" class="clr">
          <?php if($page['preface_first']): ?><div class="span_1_of_4 col col-1 preface-block ">
            <?php print render ($page['preface_first']); ?>
          </div><?php endif; ?>
          <?php if($page['preface_middle']): ?><div class="span_1_of_4 col col-2 preface-block ">
            <?php print render ($page['preface_middle']); ?>
          </div><?php endif; ?>
		 <?php if($page['preface_third']): ?><div class="span_1_of_4 col col-3 preface-block ">
            <?php print render ($page['preface_third']); ?>
          </div><?php endif; ?>
          <?php if($page['preface_last']): ?><div class="span_1_of_4 col col-3 preface-block ">
...
<?php if ($is_front): ?> 
  <div id="welcome" class="site-main container clr">
  ...
  <div id="main" class="site-main container clr">
    ...
    <div id="primary" class="content-area clr">
      <section id="content" role="main" class="site-content <?php print $sidebarclass; ?> clr">
		...
		<?php if ($page['content_second_bottom']): ?><div id="content_second_bottom"><?php print render($page['content_second_bottom']); ?></div><?php endif; ?>
      </section>
